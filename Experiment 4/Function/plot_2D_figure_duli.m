function plot_2D_figure_duli(data_raw, type, Plane)
    ...
    for num_session = 3 :4
        plane(1:4) = Plane(num_session,1:4);
        n = [plane(1), plane(2), plane(3)];
        a_a = plane(1);
        b_a = plane(2);
        c_a = plane(3);
        d_a = plane(4);
        n_unit = n / norm(n);
        data_all(1:40,1:3) = data_raw(num_session,1:40,1:3);
        P0 = [mean(data_all(1:40,1)),...
              mean(data_all(1:40,2)),...
              mean(data_all(1:40,3))];
        pointt = 3;
