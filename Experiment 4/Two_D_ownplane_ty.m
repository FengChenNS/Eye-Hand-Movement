clc
clear
data = load("Scotter_data_ownplane_ty.mat");
...
for time = 1 : 10000
    ...
    for session = 1 : 4
        ...
        [a(session,1),b(session,1),c(session,1),d(session,1)] = ...
            threedplane2(EE(1:4,1), EE(1:4,2), EE(1:4,3));
        [a(session,2),b(session,2),c(session,2),d(session,2)] = ...
            threedplane2(HH(1:4,1), HH(1:4,2), HH(1:4,3));
...
%%
plot_2D_figure_duli(dataE_all,1,Plane_E);
plot_2D_figure_duli(dataH_all,2,Plane_H);
